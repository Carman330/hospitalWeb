	...
	function ga(z, s) {
		...
		function o(b) {
			i.find(".carousel-item").each(function(d) {
				...
				var D = Math.sin( - (p * d) + v * 0.5 + b * w) * a.settings.verticalRadius + P - f * 0.5,
		...
		function X() {
			...
			function() {
				canScrollEnd = true;
				$tar && $tar.trigger('click') && c(document).unbind("mousemove", b);
			})
		}
		function Y() {
